...
namespace RobotActionStates
{
    public class RobotActionState
    {
        ...
        public IList<ObjectOfInterestVisionStatus> VisionStatusOnCreate { get; }
        public RobotActionState(IList<ObjectOfInterestVisionStatus> CurrentVisionStatus, RobotArmAction armAction, RobotLegAction legAction, RobotMotorAction motorAction, RobotWheelAction wheelAction, float weight)
        {
            ArmAction = armAction;
            LegAction = legAction;
            MotorAction = motorAction;
            WheelAction = wheelAction;
            VisionStatusOnCreate = CurrentVisionStatus;
